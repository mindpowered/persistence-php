...
class Mutator {
	...
	public function __construct ($recordType, $strategyMethod, $updateMapper, $useRecordDataAsParams) {
		#/src/persistence/Persistence.hx:284: characters 7-77
		$tmp = null;
		if (!is_string($strategyMethod)) {
			#/src/persistence/Persistence.hx:284: characters 43-77
			$f = $strategyMethod;
			#/src/persistence/Persistence.hx:284: characters 7-77
		...
		#/src/persistence/Persistence.hx:284: lines 284-286
		if ($tmp) {
			#/src/persistence/Persistence.hx:285: characters 4-9
			throw Exception::thrown("strategyMethod must be a string or function");
		}
		#/src/persistence/Persistence.hx:287: characters 7-73
		$tmp = null;
		if (!is_string($updateMapper)) {
			#/src/persistence/Persistence.hx:287: characters 41-73
			$f = $updateMapper;
			#/src/persistence/Persistence.hx:287: characters 7-73
			$tmp = !(($f instanceof \Closure) || ($f instanceof HxClosure));
		} else {
		...
		if ($tmp) {
			#/src/persistence/Persistence.hx:288: characters 4-9
			throw Exception::thrown("updateMapper must be a string or function");
		}
		#/src/persistence/Persistence.hx:290: characters 3-31
		$this->recordType = $recordType;
		#/src/persistence/Persistence.hx:291: characters 3-39
		$this->strategyMethod = $strategyMethod;
		#/src/persistence/Persistence.hx:292: characters 3-35
		$this->updateMapper = $updateMapper;
		#/src/persistence/Persistence.hx:293: characters 3-53
