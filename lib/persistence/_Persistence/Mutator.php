...
class Mutator {
	...
	public function __construct ($recordType, $strategyMethod, $updateMapper, $useRecordDataAsParams) {
		#/src/persistence/Persistence.hx:294: characters 7-77
		$tmp = null;
		if (!is_string($strategyMethod)) {
			#/src/persistence/Persistence.hx:294: characters 43-77
			$f = $strategyMethod;
			#/src/persistence/Persistence.hx:294: characters 7-77
		...
		#/src/persistence/Persistence.hx:294: lines 294-296
		if ($tmp) {
			#/src/persistence/Persistence.hx:295: characters 4-9
			throw Exception::thrown("strategyMethod must be a string or function");
		}
		#/src/persistence/Persistence.hx:297: characters 7-73
		$tmp = null;
		if (!is_string($updateMapper)) {
			#/src/persistence/Persistence.hx:297: characters 41-73
			$f = $updateMapper;
			#/src/persistence/Persistence.hx:297: characters 7-73
			$tmp = !(($f instanceof \Closure) || ($f instanceof HxClosure));
		} else {
		...
		#/src/persistence/Persistence.hx:297: lines 297-299
		if ($tmp) {
			#/src/persistence/Persistence.hx:298: characters 4-9
			throw Exception::thrown("updateMapper must be a string or function");
		}
		#/src/persistence/Persistence.hx:300: characters 3-31
		$this->recordType = $recordType;
		#/src/persistence/Persistence.hx:301: characters 3-39
		$this->strategyMethod = $strategyMethod;
		#/src/persistence/Persistence.hx:302: characters 3-35
		$this->updateMapper = $updateMapper;
		#/src/persistence/Persistence.hx:303: characters 3-53
